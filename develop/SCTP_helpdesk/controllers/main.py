...
class HelpdeskTicketController(http.Controller):
    ...
    def _get_teams(self):
        return (
            ...
            if http.request.env.user.company_id.SCTP_helpdesk_portal_select_team
            else False
        )
    ...
    def create_new_ticket(self, **kw):
        ...
        return http.request.render(
            "SCTP_helpdesk.portal_create_ticket",
            {
                ...
                "ticket_team_id_required": (
                    company.SCTP_helpdesk_portal_team_id_required
                ),
                "ticket_category_id_required": (
                    company.SCTP_helpdesk_portal_category_id_required
                ),
    ...
    def _prepare_submit_ticket_vals(self, **kw):
        ...
        vals = {
            ...
            "channel_id": request.env.ref(
                "SCTP_helpdesk.helpdesk_ticket_channel_web", False
            ).id,
        ...
        if company.SCTP_helpdesk_portal_select_team and kw.get("team"):
            team = (
                http.request.env["helpdesk.ticket.team"]
                .sudo()
                .search(
